...
@Component({
  selector: 'app-editOilStock',
  templateUrl: './editOilStock.component.html',
  styleUrls: ['./editOilStock.component.scss']
})
export class editOilStockComponent implements OnInit {
  @ViewChild('myInput')
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<editOilStockComponent>,
  ...
  uploadImage() {
    ...
    this.imageService.upLoadImage(this.image).subscribe(res => {
      ...
      this.updateOilData(); //now saving  data;
    })
