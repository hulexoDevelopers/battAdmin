...
@Component({
  selector: 'app-editBatteryCompany',
  templateUrl: './editBatteryCompany.component.html',
  styleUrls: ['./editBatteryCompany.component.scss']
})
export class editBatteryCompanyComponent implements OnInit {
  @ViewChild('myInput')
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<editBatteryCompanyComponent>,
  ...
  getBrandById() {
    this.batteryCompanyService.getBatteryCompanyById(this.brandId).subscribe(res => {
  ...
  updateBrandData() {
    ...
    this.batteryCompanyService.updateBatteryCompany(this.brandId, this.brand).subscribe(res => {
      if (res.success) {
