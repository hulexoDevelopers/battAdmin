...
@Component({
  templateUrl: './tyreCompanies.component.html',
  styleUrls: ['./tyreCompanies.component.scss'],
})
export class tyreCompaniesComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.resourceService.allCompanies) {
      this.allcompanies = this.resourceService.allCompanies.filter(data => data.tyre == 'tyre');
    }
